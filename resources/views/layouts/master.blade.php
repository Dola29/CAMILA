...
<head>
  ...
  <title>{{ config('app.name', 'CAMILA') }}</title>
...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="./img/logo.jpg" alt="CAMILA" class="brand-image img-circle elevation-3"style="opacity: .8">
      <span class="brand-text font-weight-light">CAMILA</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/suplidor" class="nav-link" active-class="active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <router-link to="/celular" class="nav-link" active-class="active">
                  <i class="nav-icon  fas fa-arrow-right" aria-hidden="true"></i>
                  <p>
                    Celulares
                  </p>
              ...
              <li class="nav-item">
                <router-link to="/linea" class="nav-link" active-class="active">
                  <i class="nav-icon fas fa-arrow-right"  aria-hidden="true"></i>
                  <p>
                    Lineas
                  </p>
          ...
          {{-- <li class="nav-item">
            <router-link to="/estatus" class="nav-link" active-class="active">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?=date('yy')?> <a href="">GRUPO 4</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
