            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h3 float-left">Adminstracion de Estados</h3>
                    ...
                    <div class="card-body ">
                        ...
                        <b-table class="col-12"
                            ...
                            <template v-slot:table-colgroup="scope">
                                ...
                                :key="field.key"
                                :style="{ width: field.key === 'accion' ? '180px' : '' || field.key === 'activo' ? '70px' : '' || field.key === 'default' ? '200px' : '' }"
                                >
                            </template>
                            ...
                            <template v-slot:cell(accion)="row">
                                ...
                                <b-button size="sm" variant="danger" @click="deleteStatus(row.item.key_id)" >
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editMode" id="createModalLabel">Crear estatus</h5>
                        <h5 class="modal-title" v-show="editMode" id="createModalLabel">Actualizar estatus</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form @submit.prevent="editMode === true ? updateStatus() : createStatus()">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 d-flex pt-3">
                                    <b-form-checkbox
                                        ...
                                        :class="{ 'is-invalid': form.errors.has('default') }"
                                        >
                                        Por Defecto
                                    </b-form-checkbox>
...
<script>
    export default {
        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    { key: 'default', label:'Por Defecto', sortable: true },
        ...
        methods:{
            getStatus(url = base_url + '/api/estatus/'){
            ...
            updateStatus(){
                this.$Progress.start();
                this.form.put('api/estatus/'+this.form.key_id)
                .then(()=>{
                    $('#createModal').modal('hide');
                    swal.fire(
                        'Actualizado!',
                        'El estatus ha sido actializada',
                        'success'
                    );
                    this.$Progress.finish();
                    Fire.$emit('AfterEvent'); 
